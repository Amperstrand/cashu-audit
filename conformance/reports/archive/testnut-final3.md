# Cashu Conformance Matrix — 2026-07-28 15:06 UTC

**Summary**: 40 passed, 14 failed, 0 skipped (54 total)
...
> ❌ `p2pk_sigall_multisig_locktime_primary_still_works` @ `https://testnut.cashu.exchange`: got 500: {'detail': 'Edge worker encountered an error', 'code': 0}

> ❌ `p2pk_sigall_multisig_before_locktime` @ `https://testnut.cashu.exchange`: got 400: {'error': 'invalid_request', 'detail': "Cannot access 'mainPubkeys' before initialization", 'code': 14005}

> ❌ `p2pk_sigall_more_signatures_than_required` @ `https://testnut.cashu.exchange`: got 400: {'error': 'invalid_request', 'detail': "Cannot access 'mainPubkeys' before initialization", 'code': 14005}

> ❌ `p2pk_sigall_refund_multisig_2of2` @ `https://testnut.cashu.exchange`: got 400: {'error': 'invalid_request', 'detail': "Cannot access 'mainPubkeys' before initialization", 'code': 14005}
...
> ❌ `htlc_sigall_preimage_only_no_pubkeys_succeeds` @ `https://testnut.cashu.exchange`: got 400: {'error': 'invalid_request', 'detail': "Cannot access 'mainPubkeys' before initialization", 'code': 14005}

> ❌ `htlc_sigall_requires_preimage_and_transaction_signature` @ `https://testnut.cashu.exchange`: got 400: {'error': 'invalid_request', 'detail': "Cannot access 'mainPubkeys' before initialization", 'code': 14005}

> ❌ `htlc_sigall_locktime_after_expiry_refund_succeeds` @ `https://testnut.cashu.exchange`: got 400: {'error': 'invalid_request', 'detail': "Cannot access 'mainPubkeys' before initialization", 'code': 14005}

> ❌ `htlc_sigall_multisig_2of3` @ `https://testnut.cashu.exchange`: got 400: {'error': 'invalid_request', 'detail': "Cannot access 'mainPubkeys' before initialization", 'code': 14005}

> ❌ `htlc_sigall_receiver_path_after_locktime` @ `https://testnut.cashu.exchange`: got 400: {'error': 'invalid_request', 'detail': "Cannot access 'mainPubkeys' before initialization", 'code': 14005}
