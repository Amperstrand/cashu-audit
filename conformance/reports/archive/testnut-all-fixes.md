# Cashu Conformance Matrix — 2026-07-28 17:12 UTC
...
> ❌ `swap_already_spent_fails` @ `https://testnut.cashu.exchange`: got 422: {'error': 'token_already_spent', 'detail': 'Proof already spent: 029577fcb1ee06fd...', 'code': 30001}
...
> ❌ `melt_valid_proofs_succeeds` @ `https://testnut.cashu.exchange`: got 500: {'error': 'internal_error', 'detail': 'Melt operation failed: Not enough blank outputs (2) for change split (3)', 'code': 10000}
